...
namespace Articy.ArticyProject
{
    ...
    public class Asset : ArticyObject, IAsset, IPropertyProvider, IObjectWithColor, IObjectWithDisplayName, IObjectWithPreviewImage, IObjectWithText, IObjectWithExternalId, IObjectWithShortId, IObjectWithPosition, IObjectWithZIndex, IObjectWithSize
    {
        ...
        [SerializeField()]
        private (UnityEngine.Object Asset, object Handle) mCachedAsset;
        ...
        {
            if ((mCachedAsset.Asset == null))
            {
                mCachedAsset = Articy.Unity.Utils.ArticyAssetHelper.LoadAsset<TAsset>(mAssetRefPath, false);
            }
            return mCachedAsset.Asset as TAsset;
        }
        
        public async Task<TAsset> LoadAssetAsync<TAsset>()
            where TAsset : UnityEngine.Object
        {
            if ((mCachedAsset.Asset == null))
            {
                mCachedAsset = await Articy.Unity.Utils.ArticyAssetHelper.LoadAssetAsync<TAsset>(mAssetRefPath, false);
            }
            return mCachedAsset.Asset as TAsset;
        }
        ...
        {
            UnityEngine.Sprite assetSprite = LoadAsset<UnityEngine.Sprite>();
            if ((assetSprite != null))
            {
                return assetSprite;
            }
        ...
        public async Task<Sprite> LoadAssetAsSpriteAsync()
        {
            UnityEngine.Sprite assetSprite = await LoadAssetAsync<Sprite>();
            if ((assetSprite != null))
            {
                return assetSprite;
            }
            ...
            {
                UnityEngine.Texture2D assetTexture = await LoadAssetAsync<Texture2D>();
                if ((assetTexture != null))
                {
                    UnityEngine.Rect spriteRect = new UnityEngine.Rect(0, 0, assetTexture.width, assetTexture.height);
                    return UnityEngine.Sprite.Create(assetTexture, spriteRect, UnityEngine.Vector2.zero);
        ...
        {
            Articy.Unity.Utils.ArticyAssetHelper.UnloadAsset(mCachedAsset);
            mCachedAsset.Asset = null;
            mCachedAsset.Handle = null;
        }
